...
const Hero = () => {
  return (
    <div className=" min-h-screen">
      ...
      {/* Product Cards */}
      <div className="px-10 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
        {PrdctAry.map((product) => (
          ...
          >
            ...
            <div className="flex flex-col justify-between flex-grow p-4">
              <div>
                <h1 className="text-base font-semibold text-gray-900 mb-2 line-clamp-2 leading-tight min-h-[3rem]">
                  {product.name}
                </h1>
